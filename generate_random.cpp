...
int main()
{
    ...
    */
    ...
    answer = "The output of rand() 10 numbers between 0 and RANDMAX" ; // 1. Write your answer to Q1 in between " "
    ...
    answer = "The output of rand()%5 is 10 numbers between 0 and 4 (inclusive)" ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "The output of rand()%5+3 is 10 numbers between 0 and 4 and then adding 3 to them" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "The code still operated but ran the same numbers It continued because the srand function allows for new random generations." ; // 4. Write your answer to Q4 in between " "
